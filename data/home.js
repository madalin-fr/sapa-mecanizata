export default ({
    "en":{
        carousels: [
            {
                ...
                'image': 'banner/banner-img-1.webp',
                'join_message': '¡Apply!',
        ...
        metrics: [
            {
                'name': 'Capacitatea de producție pe zi',
                'value': '500m2 șapă mecanizată'
            },
            {
                'name': 'Calitatea și conformitatea',
                'value': '100%'
            },
            {
                'name': 'Viteză de livrare',
                'value': '3 zile'
            },
            {
                'name': 'Rata de repetare a afacerii',
                'value': '40%'
            }
        ]
    },
    "ro": {
        ...
        metrics: [
            {
                'name': 'Capacitatea de producție șapă mecanizată pe zi',
                'value': '500m²'
            },
            {
                'name': 'Calitatea și conformitatea',
